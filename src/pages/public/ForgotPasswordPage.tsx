...
export default function ForgotPasswordPage() {
    ...
    return (
        <div className="min-h-screen flex justify-center items-center p-4 bg-gradient-to-br from-indigo-100 via-blue-50 to-white relative overflow-hidden font-sans">
            ...
            <div className="absolute top-10 right-10 w-72 h-72 bg-blue-300 rounded-full mix-blend-multiply filter blur-3xl opacity-40 animate-blob"></div>
            <div className="absolute bottom-10 left-10 w-72 h-72 bg-indigo-300 rounded-full mix-blend-multiply filter blur-3xl opacity-40 animate-blob" style={{ animationDelay: '2s' }}></div>
            ...
            <div className="bg-white/90 backdrop-blur-xl shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-white rounded-[3rem] p-8 md:p-12 w-full max-w-md relative z-10 text-center">
                ...
                {/* Ikon Gembok Bubbly */}
                <div className="w-24 h-24 bg-indigo-50 text-indigo-600 rounded-full flex items-center justify-center text-5xl mx-auto mb-8 shadow-inner">
                    🔓
                </div>
                ...
                <form onSubmit={submit} className="space-y-6 text-left">
                    ...
                    <button
                        type="submit"
                        className="w-full bg-indigo-600 text-white font-black text-lg py-4 rounded-full shadow-[0_8px_20px_rgba(79,70,229,0.3)] hover:-translate-y-1 hover:shadow-lg hover:bg-indigo-500 transition-all active:scale-95"
                    >
                        Send Reset Link
                    </button>
                </form>
                ...
                {message && (
                    <div className="mt-6 bg-emerald-50 text-emerald-600 border border-emerald-100 p-4 rounded-2xl font-bold text-sm animate-fade-in-up">
                        ✅ {message}
                    </div>
                )}
